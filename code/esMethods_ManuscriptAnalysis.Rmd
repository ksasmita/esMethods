...
This script analyses the bootstrapped agreement values reported in: asmita, K. & Swallow, K. M. (2021). Measuring Event Segmentation: An Investigation into the Stability of Event Boundary Agreement Across Groups. 

For each agreement measure it: 
1. Fit same agrement values to growth and decay functions. If stabilization occurred, calculate the elbow of stabilization (based on best fitting function)
2. Plot change in agreement values with increasing sample size & function fits. 
3. Fit linear mixed effect models to investigate whether each agreement measure: 
    a) can distinguish real segmentation data from random behavior 
    b) can distrnguish segmentation on different movies 
    c) can stabilize with enough sample size 
...
```{r message = FALSE, warning = FALSE, peakiness_functionFits, cache = TRUE}
...
```{r message = FALSE, warning = FALSE, peakiness_manuscriptPlot, cache = TRUE}
...
```{r message = FALSE, warning = FALSE, peakiness_functionFit_manuscriptPlot, cache = TRUE}
...
```{r message = FALSE, warning = FALSE, peakiness_analysis, cache = TRUE}
...
```{r message = FALSE, warning = FALSE, peaktopeak_functionFits, cache = TRUE}
...
```{r warning = FALSE, message = FALSE, peaktopeak_manuscriptPlot, cache = TRUE}
...
```{r warning = FALSE, message = FALSE, peatopeakfunctionFit_manuscriptPlot, cache = TRUE}
...
```{r warning = FALSE, message = FALSE, peaktopeak_analysis, cache = TRUE}
...
```{r message = FALSE, warning = FALSE, agreementIndex_functionFits, cache = TRUE}
...
```{r warning = FALSE, message = FALSE, agreementIndex_manuscriptPlot, cache = TRUE}
...
```{r warning = FALSE, message = FALSE, agreementfunctionFit_manuscriptPlot, cache = TRUE}
...
```{r warning = FALSE, message = FALSE, agreementIndex_analysis, cache = TRUE}
...
```{r warning = FALSE, message = FALSE, surpriseIndex_functionFits, cache = TRUE}
...
Log10 transformed peak-to-peak distance over increasing sample sizes for segmentation of: A) commercial-lab and B) everyday-online. 
```{r warning = FALSE, message = FALSE, surpriseIndex_manuscriptPlot, cache = TRUE}
...
Peak-to-peak values fit to various growth and decay functions over increasing sample sizes for segmentation of: A) commercial-lab and B) everyday-online. 
```{r warning = FALSE, message = FALSE, surprisefunctionFit_manuscriptPlot, cache = TRUE}
...
```{r warning = FALSE, message = FALSE, surpriseIndex_analysis, cache = TRUE}
...
```{r warning = FALSE, message = FALSE, normativeHit_functionFits, cache = TRUE}
...
```{r warning = FALSE, message = FALSE, predictive_detection_manuscriptPlot, cache = TRUE}
...
```{r warning = FALSE, message = FALSE, predictive_detectionfunctionFit_manuscriptPlot, cache = TRUE}
...
```{r warning = FALSE, message = FALSE, normativeHit_analysis, cache = TRUE}
